...
namespace AdminApi.Migrations
{
    ...
    [Migration("20241217092711_rebase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdminApi.Models.BookGenre", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("AdminApi.Models.BookGenreBookTitle", b =>
                {
                    b.Property<long>("BookGenreId")
                        .HasColumnType("bigint");

                    b.Property<long>("BookTitleId")
                        .HasColumnType("bigint");

                    b.HasKey("BookGenreId", "BookTitleId");

                    b.HasIndex("BookTitleId");

                    b.ToTable("BookGenresBookTitles");
                });
            ...
            modelBuilder.Entity("AdminApi.Models.ComputerLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("AdminApi.Models.SupportTicketMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("AdminApi.Models.User", b =>
                {
                    ...
                    b.Property<string>("AccessCardImagePath")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("AdminApi.Models.BookGenreBookTitle", b =>
                {
                    b.HasOne("AdminApi.Models.BookGenre", "BookGenre")
                        .WithMany("BookGenreBookTitles")
            ...
            modelBuilder.Entity("AdminApi.Models.SupportTicketMessage", b =>
                {
                    b.HasOne("AdminApi.Models.SupportTicket", "SupportTicket")
            ...
            modelBuilder.Entity("AdminApi.Models.BookGenre", b =>
                {
                    b.Navigation("BookGenreBookTitles");
                });
